...
public final class Image {
	...
	public static int statusBack = R.drawable.status_back;
	public static int animate[] = { R.drawable.unit01, R.drawable.unit02,
			R.drawable.unit03, R.drawable.unit04, R.drawable.unit05,
			R.drawable.unit06, R.drawable.unit07, R.drawable.unit08,
			R.drawable.unit09 };
}
